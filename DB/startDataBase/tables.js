...
exports.bolsista = "create table bolsista( id char(11), nome varchar(45), senha varchar(255), data_inicio date, carga_horaria int, setor int, primary key(id), foreign key(setor) references setor(id) on update cascade on delete cascade )"
